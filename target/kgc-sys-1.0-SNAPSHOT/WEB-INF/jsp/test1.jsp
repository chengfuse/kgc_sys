...
<script type="text/html" id="optBtn">
    <div class="layui-btn-container">
        <button class="layui-btn" lay-event="addBug">导出</button>
    </div>
</script>
        ...
        table.render({
           ...
           ,toolbar:'#optBtn'
            ...
            ,cols: [[
                ...
                ,{field:'name', width:80, title: '学生姓名'}
                ,{field:'recodeDate', width:80, title: '打卡时间',templet:function(){
                    return '2021-03-18 13:00:00'
                    }}
